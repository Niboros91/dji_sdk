...
#include "dji_sdk_demo/test_nico.h"
...
int main(int argc, char** argv)
{
 ...
 // ros::Subscriber path = nh.subscribe("dji_sdk/path", 10, &path_callback);
    ...
    switch(square_mission.state)
    {
      ...
      case 1:
        ...
        else
        {
          ...
          square_mission.start_gps_location = current_gps;
          square_mission.start_local_position = current_local_pos;
          square_mission.setTarget(20, 0, 0, 60);
...
//void path_callback(const dji_sdk::path msg)
//{
//  path = msg.numPoint;
//}
