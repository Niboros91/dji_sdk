...
#ifndef DJI_SDK_DEMO_INCLUDE_DJI_SDK_DEMO_TEST_NICO_H_
#define DJI_SDK_DEMO_INCLUDE_DJI_SDK_DEMO_TEST_NICO_H_
...
public:
  ...
  Mission() : state(0), inbound_counter(0), outbound_counter(0), break_counter(0),
              ...
              finished(false), Landing_result(false)
  {
  }
...
#endif /* DJI_SDK_DEMO_INCLUDE_DJI_SDK_DEMO_TEST_NICO_H_ */
